//
//  ParallelNSOperationViewController.swift
//  KMeansExploration
//
...
final class ParallelNSOperationViewController: UIViewController {
    ...
    private lazy var viewModel = ParallelNSOperationViewModel()
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        // Run the algorithm asynchronously using a global queue
        DispatchQueue.global(qos: .default).asyncAfter(deadline: .now() + 1.0) { [weak self] in
